...
public class DreamhouseController {
    ...
    @PostMapping
    public ResponseEntity<DreamhouseResponse> create(@Valid @RequestBody DreamhouseRequest req) {
        ...
        return ResponseEntity.created(location).body(assembler.toModel(toResponse(saved)));
    }
